...
`r params$modelType` `r params$formCode`. "Phenotype" on the y-axis is `r params$phenotype`. Note that in TIDAL continuous covariates are mean centered and categorical covariates are set to the lowest level by default.
