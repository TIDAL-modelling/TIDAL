...
knitr::include_graphics("TIDAL.png")
```
...
if(is.ggplot(params$plotScore)){
  ...
  knitr::kable(tablescore, digits = 3,  "latex")  %>%
      # kableExtra::column_spec(2:ncol(tablescore), width = c("10em")) %>%
...
if(!is.na(params$difTab)){
  difTab = t(params$difTab)
    knitr::kable(difTab, digits = 3,  "latex")  %>%
