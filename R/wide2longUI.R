        ...
        tabPanel("Instructions",
                 tagList(
                   ...
                   tags$ol(
                     ...
                     tags$li('Default names for the new columns are "age", "time_point" and "dep". You can change these in the text boxes provided if you wish, but make sure they are unique and also are not names of columns that already exist in your dataset.'),
