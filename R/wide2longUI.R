      ...
      tabsetPanel(
        tabPanel("Instructions",
                 tagList(
                   ...
                   h4("Steps:"),
                   tags$ol(
                     tags$li('Upload a wide format .csv or .tsv file of your dataset. It is recommended your longitudinal dataset has at least 4 time points. This must be less than 30 MB and column names must not have any spaces in them. Click on the "Output" tab and proceed with the following steps.'),
